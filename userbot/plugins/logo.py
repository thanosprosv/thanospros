...
@THANOSPRO.cat_cmd(
    ...
    info={
        ...
        "examples": [
            "{tr}logo THANOSBOT",
            "{tr}logo 10;THANOSBOT",
            "{tr}flogo THANOSBOT",
            "{tr}flogo 5; THANOSBOT",
            "{tr}slogo THANOSBOT",
        ],
    },
)
async def very(event):  # sourcery no-metrics
    ...
    LOGO_BACKGROUND = loader2 = (
        ...
        or "https://github.com/rishabhanand2/THANOS-V2-Resources/raw/master/Resources/Logo/Background/black.jpg"
    )
    LOGO_FONT = loader3 = (
        gvarstatus("LOGO_FONT")
        or "https://github.com/rishabhanand2/THANOS-V2-Resources/blob/master/Resources/Logo/Fonts/Streamster.ttf?raw=true"
    )
    rcheck = random_checker(LOGO_FONT, LOGO_FONT_COLOR, LOGO_BACKGROUND)
    if rcheck:
        rjson = requests.get(
            "https://raw.githubusercontent.com/TgTHANOSPRO/THANOSBOT-Resources/master/Resources/Logo/resources.txt"
        ).json()
...
async def bad(event):
    ...
    string = (
        ...
        else f"https://github.com/rishabhanand2/THANOS-V2-Resources/raw/master/Resources/Logo/Background/{input_str}.jpg"
    )
...
async def pussy(event):  # sourcery no-metrics
    ...
    if cmd == "":
        source = requests.get(
            "https://github.com/rishabhanand2/THANOS-V2-Resources/tree/master/Resources/Logo/Fonts"
        )
        ...
        if input_str != "Random":
            ...
            string = f"https://github.com/rishabhanand2/THANOS-V2-Resources/blob/master/Resources/Logo/Fonts/{input_str}.ttf?raw=true"
