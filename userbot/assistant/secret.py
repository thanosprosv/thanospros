...
@THANOSPRO.tgbot.on(CallbackQuery(data=re.compile(b"secret_(.*)")))
async def on_plug_in_callback_query_handler(event):
    ...
    if os.path.exists("./userbot/secret.txt"):
        ...
        try:
            ...
            reply_pop_up_alert = "This message no longer exists in THANOSPRO server"
    else:
